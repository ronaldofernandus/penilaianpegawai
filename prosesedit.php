      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="views/tabelpenilaian.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tabel Penilaian</p>
                </a>
              </li>
...
<?php
      ...
      $sql_edit=mysqli_query($conn,"SELECT * FROM nilai_pak WHERE ID='$getid'");

      if($sql_edit == FALSE) {
        echo "<b style='color: red;'>Query Error</b>";
      }
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <label for="exampleInputTanggal_Bulan_Tahun1">Tanggal_Bulan_Tahun</label>
                 <input type="date" class="form-control" id="Tanggal_Bulan_Tahun" name="Tanggal_Bulan_Tahun" placeholder="" value="<?php echo $data['Tanggal_Bulan_Tahun'] ?>">
                 <label for="exampleInputKeterangan1">Nama</label>
    <input type="text" class="form-control" id="exampleInputKeterangan1" name="Nama" placeholder="" value="<?php echo $data['Nama'] ?>">
    ...
    <select class="form-control" id="nilai" name="Butirkegiatan" onchange="validasi();">
      <option hidden><?php echo $data['ButirKegiatan']?></option>
<?php
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="exampleInputAngkaSkor1" name="Nilai" placeholder="" onkeyup="totalnilai();" value="<?php echo $data['Nilai'] ?>" readonly/>
...
<!--                </div>
 <div class="form-group">-->
  ...
  <input type="text" class="form-control" id="exampleInputJumlah1" placeholder="" name="Jumlah" onkeyup="totalnilai();"   value="<?php echo $data['Jumlah'] ?>"/>
<!--                </div>
  <div class="form-group">-->
    <label for="exampleInputTotalNilai1">TotalNilai</label>
    <input value="<?php echo $data['TotalNilai'] ?>"  type="text" class="form-control" id="exampleInputTotalNilai1" name="TotalNilai" placeholder="" readonly/>
