          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabel PNS</h3>
                <form action="cetakpns.php" method="post">
<button type="penilaian" name="penilaian" class="float-right" class="glyphicon glyphicon-print">Cetak</button>
              </div>
</form>
              </div>
              <!-- /.card-header -->
    ...
    INNER JOIN golongan ON pns.nama_golongan = golongan.Golongan_id";
      ...
      while ($row=mysqli_fetch_array($result)){?>
        ...
        <tr>
                    ...
                    <td><?php print $row['nama_jabatan']; ?></td>
                    <td><?php print $row['nama_golongan']; ?></td>
